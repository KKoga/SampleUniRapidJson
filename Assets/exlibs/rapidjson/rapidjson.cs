...
#pragma warning restore
    ...
    public struct Value
    {
        ...
        {
            return new Object(doc, ref ptr);
        }

        public bool IsAllocated()
        {
            return doc != null && ptr != IntPtr.Zero;
        }
        ...
        public Value this[string name]
        {
            ...
            {
                doc.CheckDisposed();
                var p = DLL.Get(ref ptr, name);
                return new Value(doc, ref p);
            }
        }
        ...
        public Value this[int index]
        {
            get
            {
                ...
                doc.CheckDisposed();
                var p = DLL.Get(ref ptr, (uint)index);
                return new Value(doc, ref p);
            }
        }
        ...
        public bool TryGetValueByPointer(string pointer, out Value value)
        {
            ...
            value = new Value(ret ? doc : null, ref dst);
            return ret;
        }
    ...
    public class Array : IEnumerable<Value>, IEnumerable
    {
        ...
        public IEnumerator<Value> GetEnumerator()
        {
            ...
            {
                var p = (IntPtr)itr;
                yield return new Value(doc, ref p);
            }
        }
    ...
    public class Object : IEnumerable<KeyValuePair<string, Value>>, IEnumerable
    {
        ...
        public IEnumerator<KeyValuePair<string, Value>> GetEnumerator()
        {
            for (uint i = 0; i < size; ++i)
            {
                ...
                yield return new KeyValuePair<string, Value>(key, new Value(doc, ref value));
            }
        }
        ...
        public bool TryGetValue(string name, out Value value)
        {
            doc.CheckDisposed();
            var ptr = IntPtr.Zero;
            var ret = DLL.TryGet(ref root, name, out ptr);
            value = new Value(ret ? doc : null, ref ptr);
            return ret;
        }
        ...
        public bool HasMember(string name)
        {
            doc.CheckDisposed();
            var ptr = IntPtr.Zero;
            return DLL.TryGet(ref root, name, out ptr);
        }
    }
    ...
    static class DLL
    {
        ...
        {
            IntPtr dst;
            if (!TryGet(ref src, name, out dst))
            {
